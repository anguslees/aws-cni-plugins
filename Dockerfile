...
FROM --platform=$BUILDPLATFORM golang:1.17.2@sha256:124966f5d54a41317ee81ccfe5f849d4f0deef4ed3c5c32c20be855c51c15027 AS builder
...
FROM --platform=$BUILDPLATFORM debian:stable AS cniplugins
